            ...
            <template #search>
                <search-col>
                    <a-form-item field="user_id" :label="$t('user_yongjin_log.user_id')">
                        <remote-select url="/web/user/User/index" labelField="username" valueField="id" v-model="store.searchQuery.user_id" :placeholder="$t('user_yongjin_log.userIdPlaceholder')"/>
                    </a-form-item>
                </search-col>
                <search-col>
                    <a-form-item field="memo" :label="$t('user_yongjin_log.memo')">
                        <a-input v-model="store.searchQuery.memo" :placeholder="$t('user_yongjin_log.memoPlaceholder')"/>
                    </a-form-item>
                </search-col>
            </template>
...
const store = provideIndexShareStore({
    columns: [
        ...
        {title: __('user_yongjin_log.user_id'), dataIndex: 'user.username',},
