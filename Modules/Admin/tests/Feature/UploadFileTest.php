...
class UploadFileTest extends AbstractAuthTestCase
{
    ...
    public function test_public_disabled()
    {
        ...
        $this->assertEquals($response->json('message'), __('admin::system_upload_file.upload_status_disabled'));
    }
    ...
    public function test_temporary_url_public()
    {
        ...
        $this->assertEquals($response->json('message'), __('admin::system_upload_file.public_temporary_tip'));
    }
