...
class RouteServiceProvider extends ServiceProvider
{
    ...
    protected function mapSystemMenuGroup()
    {
        ...
        if (app()->environment('local')) {
            ...
            SystemMenuRegisterService::getInstance()->pushSystemMenu(new SystemMenu('Font Awesome', url: 'https://fontawesome.com/search?ic=free', type: SystemMenuType::LINK, code: 'fontawesome.com', icon: 'fas fa-icons', parent_code: 'system.dev'));
        }
    }
