...
use Modules\CrudGenerate\Classes\FieldControlDatePicker;
use Modules\CrudGenerate\Classes\FieldControlDictCheckbox;
use Modules\CrudGenerate\Classes\FieldControlDictRadio;
use Modules\CrudGenerate\Classes\FieldControlDictSelect;
use Modules\CrudGenerate\Classes\FieldControlInput;
use Modules\CrudGenerate\Classes\FieldControlInputNumber;
use Modules\CrudGenerate\Classes\FieldControlInputRange;
...
class CrudGenerateServiceProvider extends ServiceProvider
{
    ...
    public function boot(FieldControlService $fieldControlService, PageViewControlService $pageViewControlService): void
    {
        ...
        $pageViewControlService->add(new FieldControlInput);
        $pageViewControlService->add(new FieldControlInputNumber);
        $pageViewControlService->add(new FieldControlInputRange);
        ...
        $pageViewControlService->add(new FieldControlDictCheckbox);
        $pageViewControlService->add(new FieldControlRadio);
        $pageViewControlService->add(new FieldControlDictRadio);
        $pageViewControlService->add(new PageViewControlSwitch);
        $pageViewControlService->add(new FieldControlSelect);
        $pageViewControlService->add(new FieldControlRemoteSelect);
        $pageViewControlService->add(new FieldControlDictSelect);
        $pageViewControlService->add(new FieldControlDatePicker);
        $pageViewControlService->add(new PageViewControlTimePicker);
        $pageViewControlService->add(new FieldControlRate);
        $pageViewControlService->add(new PageViewControlSlider);
        $pageViewControlService->add(new PageViewControlUploadFile);
        $pageViewControlService->add(new PageViewControlUploadImage);
    }
